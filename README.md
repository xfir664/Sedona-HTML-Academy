# Данный проект в рамках обучения без использования инструментов от HTML-Academy!

## Далее ниже идет с readme файла от HTML-Academy

## Сборка ReactTS + Redux
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2298933-sedona-38) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
